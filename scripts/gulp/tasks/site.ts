...
/** Run `ng build --prod --project=ant-design-blazor-doc` */
task(
  'build:site-doc',
  execNodeTask('@angular/cli', 'ng', [
    'build',
    '--project=ant-design-blazor-doc',
    '--prod',
    CI ? '--configuration=pre-production' : ''
  ])
);

/** Run `ng build --prod --project=ant-design-blazor-doc --configuration es5` */
task(
  'build:site-doc-es5',
  execNodeTask('@angular/cli', 'ng', ['build', '--project=ant-design-blazor-doc', '--prod', '--configuration=es5'])
);

/** Run `ng build --prod --base-href ./ --project=ant-design-blazor-iframe` */
task(
  'build:site-iframe',
  execNodeTask('@angular/cli', 'ng', [
    'build',
    '--project=ant-design-blazor-iframe',
    '--configuration',
    'production',
    '--base-href=./'
  ])
...
task('site:replace-path', () => {
  ...
  tsconfig.compilerOptions.paths['ant-design-blazor'] = ['../publish'];
  tsconfig.compilerOptions.paths['ant-design-blazor/*'] = ['../publish/*'];
...
/** Task that use source code to build ant-design-blazor-doc project,
 * output not included issue-helper/iframe and prerender.
 */
task('build:simple-site', series('init:site', 'build:site-doc'));

/** Task that use publish code to build ant-design-blazor-doc project,
