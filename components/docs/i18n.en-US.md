...
`Ant Design Blazor` supports RTL (Right-to-Left) layout direction for languages such as Arabic, Hebrew, and other right-to-left scripts.

Set the `Direction` parameter on the `ConfigProvider` component:
