...
namespace AntDesign
{
    public partial class Empty : AntDomComponentBase
    {
        ...
        [Parameter] public OneOf<string, bool, RenderFragment> Description { get; set; } = "暂无数据";

        [Parameter] public OneOf<string, RenderFragment> Image { get; set; } = Empty.PRESENTED_IMAGE_DEFAULT;
