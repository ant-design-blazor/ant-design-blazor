...
{
    public sealed partial class OverlayUnbound : AntDomComponentBase
    {
        [CascadingParameter(Name = "Trigger")]
        public OverlayTriggerUnbound Trigger { get; set; }

        [CascadingParameter(Name = "ParentTrigger")]
        public OverlayTriggerUnbound ParentTrigger { get; set; }
        ...
        internal async Task Show(int? overlayLeft = null, int? overlayTop = null)
        {
            ...
            Element trigger = await JsInvokeAsync<Element>(JSInteropConstants.GetDomInfo, Trigger.Ref);
