/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+csharp */
var _self =
    ...
    Prism = function(u) {
            ...
            C = {
                    ...
                    clone: function t(e, r) {
                        ...
                        case"Array":
                            return n = C.util.objId(e), r[n]
                                ? r[n]
                                : (a = [], r[n] = a, e.forEach(function(e, n) { a[n] = t(e, r) }), a);
                        default:
                            return e
                        }
                    },
                ...
                languages: {
                    ...
                    insertBefore: function(t, e, n, r) {
                        ...
                        var s = r[t];
                        return r[t] =
                            l, C.languages.DFS(C.languages, function(e, n) { n === s && e != t && (this[e] = l) }), l
                    },
                ...
                highlightAllUnder: function(e, n, t) {
                    ...
                    C.hooks.run("before-highlightall", r), r.elements =
                        Array.prototype.slice.apply(r.container.querySelectorAll(r.selector)), C.hooks.run(
                ...
                highlightElement: function(e, n, t) {
                    ...
                    function o(e) {
                        i.highlightedCode = e, C.hooks.run("before-insert", i), i.element.innerHTML =
                            i.highlightedCode, C.hooks.run("after-highlight", i), C.hooks.run("complete", i), t &&
                            t.call(i.element)
                    }
                    ...
                    if (C.hooks.run("before-highlight", i), i.grammar)
                        if (n && u.Worker) {
                            ...
                            s.onmessage =
                                function(e) { o(e.data) }, s.postMessage(JSON.stringify({
                                language: i.language,
                                code: i.code,
                                immediateClose: !0
                            }))
                ...
                highlight: function(e, n, t) {
                    ...
                    return C.hooks.run("before-tokenize", r), r.tokens =
                        C.tokenize(r.code, r.grammar), C.hooks.run("after-tokenize", r), _.stringify(
                        C.util.encode(r.tokens),
                        r.language)
                },
                                    ...
                                    for (var y = a.next, k = l; y !== t.tail; k += y.value.length, y = y.next) {
                                        ...
                                        if (!(b instanceof _)) {
                                            ...
                                            if (w) {
                                                ...
                                                if (y = M(t, j, L), N && M(t, y, N), 1 < x &&
                                                    e(n, t, r, y.prev, k, !0, s + "," + c), i) break
                                            } else if (i) break
                                        }
                                    }
                                }
        ...
        if (u.Prism = C, _.stringify = function n(e, t) {
            ...
            var a = {
                ...
                l = e.alias;
            l && (Array.isArray(l) ? Array.prototype.push.apply(a.classes, l) : a.classes.push(l)), C.hooks.run("wrap",
                a);
            var i = "";
...
Prism.languages.markup =
    ...
    Object.defineProperty(Prism.languages.markup.tag,
        ...
        }), Prism.languages.xml = Prism.languages.extend("markup", {}), Prism.languages.html =
...
!function(s) {
    ...
    t &&
    (t.tag.addInlined("style", "css"), s.languages.insertBefore("inside",
        "attr-value",
        {
            "style-attr": {
...
!function(e) {
    ...
    for (var a = [
                 "comment", "function-name", "for-or-select", "assign-left", "string", "environment", "function",
                 "keyword", "builtin", "boolean", "file-descriptor", "operator", "punctuation", "number"
             ],
        r = n.variable[1].inside,
        s = 0;
        s < a.length;
        s++) r[a[s]] = e.languages.bash[a[s]];
...
!function(s) {
    ...
    function e(e, n) {
        for (var s = 0; s < n; s++) e = e.replace(/<<self>>/g, function() { return"(?:" + e + ")" });
    ...
    var d = l(i),
        ...
        k = "\\[\\s*(?:,\\s*)*\\]",
        y = a("(?:<<0>>|<<1>>)(?:\\s*(?:\\?\\s*)?<<2>>)*(?:\\s*\\?)?",
            [a("\\(<<0>>+(?:,<<0>>+)+\\)", [a("[^,()<>[\\];=+\\-*/%&|^]|<<0>>|<<1>>|<<2>>", [g, b, k])]), m, k]),
        w = { keyword: p, punctuation: /[<>()?,.:[\]]/ },
        v = "'(?:[^\r\n'\\\\]|\\\\.|\\\\[Uux][\\da-fA-F]{1,8})'",
        x = '"(?:\\\\.|[^\\\\"\r\n])*"';
    s.languages.csharp =
            s.languages.extend("clike",
                {
                    string:
                    [
                        {
        ...
        s.languages.insertBefore("csharp",
            "punctuation",
            {
